...
Representative values at $V=3{,}000$: $0.242$, $0.438$, $0.573$, $0.660$,
$0.711$, $0.746$ for $k=4,8,16,32,64,128$ respectively.
As expected, the \emph{indexed} binary heap achieves skip\_ratio$\,=0$
throughout by maintaining a position array for $O(\log V)$ decrease-key.
