...
systematically quantified as a closed-form function of graph structure.  We identify \emph{skip\_ratio}---the
...
$[0.254,\,0.323]$ ($B{=}10{,}000$), consistent with the full-range
estimate at the two-standard-error level.
