...
we ran a Python supplemental experiment across $V\in\{500,1000,3000,5000,10000\}$
and $k\in\{4,8,16,32,64,128\}$ with five repetitions each
($\mathrm{U}[1,100]$, same protocol as Sections~\ref{sec:analysis}--\ref{sec:comparison}).
